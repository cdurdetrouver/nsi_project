...
class Projectile(pygame.sprite.Sprite):
    ...
    def __init__(self, fusee, screen_size, pluie):
        ...
        self.image = pygame.transform.scale(self.image, (self.fusee.sprite.get_size()[1] * 0.3 * self.image.get_size()[0]/self.image.get_size()[1], self.fusee.sprite.get_size()[1] * 0.3))
        self.launch = False
        ...
        self.rect.x = self.fusee.pos[0] + self.fusee.sprite.get_size()[0] / 2 - self.image.get_size()[0] / 2
        self.rect.y =  self.fusee.pos[1] + self.fusee.sprite.get_size()[1] / 2 - self.image.get_size()[1]
